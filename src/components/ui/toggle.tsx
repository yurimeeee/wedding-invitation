...
import { PINK_300 } from '@styles/colors';
...
export function CustomToggle({ leftText, rightText, checked, onChange }: CustomToggleProps) {
  return (
    <div aria-label="Toggle" className="flex items-center gap-2">
      {leftText && <Label text={leftText} />}
      <div
      ...
      {rightText && <Label text={rightText} />}
    </div>
  );
}
